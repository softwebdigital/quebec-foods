...
//$investment = App\Models\Investment::where('id', 30)->first();
...
@endphp
    ...
    <div class="certificate" style="position: relative;">
        <div id="bg">
            ...
            <div style="text-transform: capitalize; top: 308px; left: 23%; font-size: 15px; font-weight: 900;" class="item">
            ...
            <div style="top: 507px; left: 40%; font-size: 15px; font-weight: 500;" class="item">
                {{ ucwords(strtolower($investment["package"]["name"])) }}
            </div>
            <div style="top: 538px; left: 40%; font-size: 15px; font-weight: 500;" class="item">
                {{ $code }}
            </div>
            <div style="top: 567px; left: 40%; font-size: 15px; font-weight: 500;" class="item">
                {{ $investment["user"]["email"] }}
            </div>
            <div style="top: 593px; left: 40%; font-size: 15px; font-weight: 500;" class="item">
            ...
            <div style="top: 626px; left: 40%; font-size: 15px; font-weight: 500;" class="item">
            ...
            <div style="top: 713px; left: 40%; font-size: 15px; font-weight: 500;" class="item">
                {{ $investment["investment_date"]->format("F d,  Y") }}
            </div>
            <div style="top: 742px; left: 40%; font-size: 15px; font-weight: 500;" class="item">
