                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-muted text-center rounded-end">Action</th>
                        </tr>
                        <!--end::Table row-->
                    </thead>
                    <!--end::Table head-->
                    ...
                    <tbody class="fw-bold text-gray-600">
                        @foreach ($transactions as $key=>$transaction )
                            ...
                            <tr>
                                ...
                                <td><span class="text-gray-600 fw-bolder d-block fs-6">{{ getCurrency() }} {{ number_format($transaction['amount']) }}</span></td>
                                ...
                                <td class="text-end">
                                    <a href="#"
                                        class="btn btn-sm btn-primary  @if ($transaction['status'] != 'pending') disabled @endif"
