                        ...
                        @foreach ($transactions as $key => $transaction)
                            <tr>
                                ...
                                <td><span class="text-gray-600 fw-bolder d-block fs-6"
                                        style="white-space: nowrap;">{{ $transaction['user']['name'] }}</span></td>
                                <td><span class="text-gray-600 fw-bolder d-block fs-6" style="white-space: nowrap;">₦
                                        {{ number_format($transaction['amount']) }}</span></td>
                                <td><span
                                        class="text-gray-600 fw-bolder d-block fs-6">{{ $transaction['description'] }}</span>
                                </td>
                                <td><span class="text-gray-600 fw-bolder d-block fs-6"
                                        style="white-space: nowrap;">{{ $transaction['created_at']->format('M d, Y') }}</span>
                                </td>
                                <td><span class="text-gray-600 fw-bolder d-block fs-6">{{ $transaction['method'] }}</span>
                                </td>
                                <td><span
                                        class="text-gray-600 fw-bolder d-block fs-6">{{ $transaction['channel'] }}</span>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <a href="#"
                                        class="btn btn-sm btn-light-primary btn-active-primary @if ($transaction['status'] != 'pending') disabled @endif"
                                        data-kt-menu-trigger="click" style="white-space: nowrap"
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        @if ($transaction['status'] == 'pending')
                                            @can('Approve Transactions')
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3"
                                                        onclick="confirmFormSubmit(event, 'transactionApprove{{ $transaction['id'] }}')"
                                                        href="{{ route('admin.transactions.approve', $transaction['id']) }}"><i
                                                            data-feather="user-x" class="icon-sm mr-2"></i> <span
                                                            class="">Approve</span></a>
                                                    <form id="transactionApprove{{ $transaction['id'] }}"
                                            ...
                                            @can('Decline Transactions')
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3"
                                                        onclick="confirmFormSubmit(event, 'transactionDecline{{ $transaction['id'] }}')"
                                                        href="{{ route('admin.transactions.decline', $transaction['id']) }}"><i
                                                            data-feather="user-x" class="icon-sm mr-2"></i> <span
                                                            class="">Decline</span></a>
                                                    <form id="transactionDecline{{ $transaction['id'] }}"
                                                        action="{{ route('admin.transactions.decline', $transaction['id']) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                    </form>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select class="form-select form-select-solid fw-bolder" data-placeholder="Select option"
                        ...
                        @foreach ($transactions as $key => $transaction)
                            @php
                                ...
                                if ($transaction['type'] == 'withdrawal' && $bank) {
                                    ...
                                    $details =
                                        '<button data-bs-toggle="modal" onclick="populateTransactionDetails(\'' .
                                        $account_name .
                                        '\', \'' .
                                        $account_number .
                                        '\', \'' .
                                        $bank_name .
                                        '\');" data-bs-target="#transactionDetailModal" class="btn btn-sm btn-primary" type="button">
                                                        View
                                                    </button>';
                                } else {
                                    $details = '---';
                            ...
                            <tr>
                                <td class="ps-4"><span
                                        class="text-dark fw-bolder d-block mb-1 fs-6 text-nowrap">{{ $key + 1 }}</span>
                                </td>
                                <td><span class="text-gray-600 fw-bolder d-block fs-6">₦
                                        {{ number_format($transaction['amount']) }}</span></td>
                                <td><span
                                ...
                                <td><span
                                        class="text-gray-600 fw-bolder d-block fs-6">{{ $transaction['created_at']->format('M d, Y') }}</span>
                                </td>
                                <td><span
                                        class="text-gray-600 fw-bolder d-block fs-6 text-center">{!! $details !!}</span>
                                </td>
                                <td><span
                                        class="text-gray-600 fw-bolder d-block fs-6">{{ ucwords($transaction['type']) }}</span>
                                </td>
                                <td><span
                                        class="text-gray-600 fw-bolder d-block fs-6">{{ ucwords($transaction['method']) }}</span>
                                </td>
                                <td><span
                                        class="text-gray-600 fw-bolder d-block fs-6">{{ $transaction['channel'] }}</span>
                                </td>
