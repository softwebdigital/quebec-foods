...
@section('breadCrumbs')
    ...
    @if (request('type'))
        <li class="breadcrumb-item text-muted"><a href="javscript:void()"
                class="text-dark">{{ ucwords(request('type')) }}</a></li>
    @endif
@endsection
        ...
        <div class="card-header border-0 pt-5 py-3">
            <h3 class="card-title align-items-start flex-column">
                ...
                @switch (request('type'))
                    @case ('verified')
                        <span
                            class="text-muted mt-1 fw-bold fs-7">{{ \App\Models\User::whereNotNull('email_verified_at')->count() }}
                            Total Record(s)</span>
                    @break

                    @case ('unverified')
                        <span class="text-muted mt-1 fw-bold fs-7">{{ \App\Models\User::whereNull('email_verified_at')->count() }}
                            Total Record(s)</span>
                    @break
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true"
                        ...
                        <form class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select name="type" class="form-select form-select-solid fw-bolder"
                                    data-placeholder="Select option" data-allow-clear="true"
                                    data-kt-customer-table-filter="category" data-dropdown-parent="#kt-toolbar-filter">
                                    <option @if (request('type') == 'all') selected @endif value="all">Show All</option>
                                    <option @if (request('type') == 'verified') selected @endif value="verified">Verified
                                    </option>
                                    <option @if (request('type') == 'unverified') selected @endif value="unverified">Unverified
                                    </option>
                                </select>
                                <!--end::Input-->
                            </div>
                                ...
                                <div class="d-flex flex-column flex-wrap fw-bold" data-kt-customer-table-filter="status">
                                    ...
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-3 me-5">
                                        <input class="form-check-input" type="radio" name="status"
                                            @if (request('status') == 'active') checked @endif value="active" />
                                    ...
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-3">
                                        <input class="form-check-input" type="radio" name="status"
                                            @if (request('status') == 'blocked') checked @endif value="blocked" />
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="reset" class="btn  btn-active-light-primary me-2" data-kt-menu-dismiss="true"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_customers_export_form" method="POST" class="form" action="{{ route('admin.users.export') }}">
                        @csrf
                        <!--begin::Input group-->
                        <div class="fv-row mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="category" class="form-select form-select-solid fw-bolder" data-placeholder="Select option"
