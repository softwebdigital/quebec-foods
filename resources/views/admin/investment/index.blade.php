...
<div class="modal fade" id="kt_investments_export_modal" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_investments_export_form" class="form" method="POST" action="{{ route('admin.investments.export') }}">
                    @csrf
                    <!--begin::Input group-->
...
<script>
    ...
    var KTCustomersExport = (function() {
        ...
        return {
            init: function() {
                (t = document.querySelector("#kt_investments_export_modal")),
                (i = document.querySelector("#kt_investments_export_form")),
                (function() {
