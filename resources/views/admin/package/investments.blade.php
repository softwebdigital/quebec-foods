...
@section('pageTitle', ucfirst($package->name).' Packages')
...
@section('breadCrumbs')
    ...
    <li class="breadcrumb-item"><a href="javascript:void()" class="text-dark">Investments</a></li>
@endsection
...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">{{ ucfirst($package->name) }} Investments</span>
        </h3>
    </div>
    <!--end::Header-->
    <!--begin::Body-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item px-3">
                                            <a class="menu-link px-3" href="{{ route('admin.investments.show', ['type' => $type, 'investment' => $investment['id']]) }}"><span class="">View</span></a>
                                        </div>
