                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($packages as $key=>$package )
                        <tr>
                            ...
                            <td><a href="{{ route('admin.packages.show', ['package' => $package['id'], 'type' => $package['type']]) }}"><span class="text-primary fw-bolder d-block fs-6 text-nowrap">{{ $package['formatted_name'] }}</span></a></td>
