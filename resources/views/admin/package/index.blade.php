            ...
            <table class="table align-middle gs-0 gy-4" id="data-table">
                ...
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        ...
                        <th class="text-dark">Duration in months</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span class="text-gray-600 fw-bolder d-block fs-6">Gold</span></td>
                        ...
                        <td><span class="text-gray-600 fw-bolder d-block fs-6 ">3 months</span></td>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                <div class="menu-item px-3">
                                    <a class="menu-link px-3" href="javascript:void();" onclick=""><span class="">Edit</span></a>
                                </div>
                                <div class="menu-item px-3">
                                    <a class="menu-link px-3" href="javascript:void();" onclick=""><span class="">Delete</span></a>
                                </div>
                                <div class="menu-item px-3">
