...
<div class="modal fade" id="kt_transactions_export_modal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Export Transactions</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_transactions_export_form" class="form" method="POST" action="{{ route('admin.transactions.export') }}">
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" onclick="confirmFormSubmit(event, 'kt_transactions_export_form', 'kt_transactions_export_modal')" class="btn btn-primary">
