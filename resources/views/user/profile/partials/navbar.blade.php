    ...
    <div class="card-body pt-9 pb-0">
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if (request()->routeIs(['account.overview'])) active @endif" id="overviewNav" href="{{ route('account.overview') }}">Overview</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if (request()->routeIs(['user.investments']) && request()->type == 'farm') active @endif" id="farmNav" href="{{ route('user.investments', 'farm') }}">Farms Investments</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if (request()->routeIs(['user.investments']) && request()->type == 'plant') active @endif"  id="plantNav" href="{{ route('user.investments', 'plant') }}">Plant Investments</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
            ...
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if (request()->routeIs(['user.wallet'])) active @endif" id="walletNav" href="{{ route('user.wallet') }}">Wallet</a>
            </li>
            <!--end::Nav item-->
             <!--begin::Nav item-->
             <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if (request()->routeIs(['user.referrals'])) active @endif" id="referralNav" href="{{ route('user.referrals') }}">Referrals</a>
            </li>
            <!--end::Nav item-->
        </ul>
        <!--end::Navs-->
