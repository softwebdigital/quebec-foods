                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($investments as $key=>$investment)
                        <tr>
                            ...
                            <!-- <td><span class="text-gray-600 fw-bolder d-block fs-6 text-nowrap">{{ $investment['slots'] }}</span></td> -->
                            <td><span class="text-gray-600 fw-bolder d-block fs-6 text-nowrap">{{ getCurrency() }} {{ number_format($investment['amount'], 2) }}</span></td>
                            <td><span class="text-gray-600 fw-bolder d-block fs-6 text-nowrap">{{ getCurrency() }} {{ number_format($investment['total_return'], 2) }}</span></td>
