...
Let's Help You Understand How to generate alternative income by investing in classified sustainable agricultural commodities, from production(farming) to processing and packaging for local and export markets, without having to soil your hands in the process and you earn cash value return in weeks, Months, Quarterly, biannually & Annually depending on your choice of crops.
        ...
        <div class="flex flex-col items-center justify-center my-1 text-center lg:flex-row lg:iterms-baseline lg:gap-x-6 lg:my-5">
            {{-- <a href="{{ route('login') }}"
            ...
            <a href="{{ route('login') }}"
              class="flex items-baseline justify-center w-1/2 py-5 my-4 btn-primary md:text-lg md:py-5 lg:px-9 rounded-xl gap-x-10 lg:gap-x-6 lg:w-1/2">
              <span>
                Register Now
              </span>
    ...
    <section class=" bg-[#F3FFF9] px-2">
        ...
        <div class="text-center section-container">
            <div
                class="flex flex-col items-start lg:flex-row text-left bg-center bg-no-repeat">
                <div class="md:w-1/2" style="width: 100%;">
                    <div class="w-full mt-10 lg:px-10 ">
                        <p
                            class="inline-block py-1 text-base text-ink md:text-[20px] md:leading-h-5">
            ...
            <div
                class="flex flex-col items-start lg:flex-row text-left bg-center bg-no-repeat">
                <div class="md:w-1/2" style="width: 100%;">
                    <div class="bg-primary w-full mt-10 lg:px-10 ">
                        <p
                            style="color: #fff; padding: 30px 0px 80px 10px; font-style: italic;" class="inline-block py-1 text-ink md:text-[20px] md:leading-h-5">
                ...
                <div class="md:w-1/2" style="width: 100%;">
                    <div class="w-full mt-10 lg:px-10 ">
                        ...
                        <p class="font-bold py-1" style="margin-top: 10px;">There will be Q & A session at the end where you can get your questions answered.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <section class="mt-6 lg:overflow-hidden">
        <div class="text-center section-container">
            ...
            <div
                class="flex flex-col items-start lg:flex-row text-left bg-center bg-no-repeat">
                <div class="">
                    <p class="text-md text-[#E5F0EB] mt-5">QUEBEC WEBINAR</p>
                    <h2 class="text-4xl lg:text-heading-3 lg:leading-h-3 text-[#192434] font-bold mb-5">Why should I trust Quebec Foods?</h2>
                </div>
                <div class="md:w-1/2" style="width: 100%;">
                    <div class="w-full mt-10 lg:px-10 ">
                        <p
