...
@section('content')
  ...
  <!-- Testimonial -->
  <section>
    <div class="overflow-hidden text-white bg-primary">
  ...
  <section class="mobile-cta-section">
    <div
      ...
      <div class="px-3 lg:col-start-5 lg:col-end-9 lg:px-0">
        <div class="relative w-full my-6 bg-primary curved lg:my-0 lg:px-16 lg:py-24" style="border-radius: 0px 40px 40px 0px; padding-top: 2rem; padding-bottom: 2rem;" style="border-radius: 0px 40px 40px 0px; padding-top: 2rem; padding-bottom: 2rem;">
